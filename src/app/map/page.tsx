...
export default async function MapPage() {
  ...
  return (
    <AppShell currentCityNames={cities.map((city) => city.name)}>
      <PageContainer>
        <header className="flex flex-col gap-3 rounded-[28px] bg-surface-elevated/[0.65] p-5 shadow-panel md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-content-muted">
              Filter restaurants, select markers and open detailed food places.
            </p>
          </div>
